...
createServer({
  ...
  routes() {
    ...
    // Permettre les appels vers l'API externe
    this.passthrough("http://localhost:8009/**");
    this.passthrough("http://localhost:8009/api/**");
    this.passthrough((request) => {
      return request.url.includes('localhost:8009');
    });
  },
});
